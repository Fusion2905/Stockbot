...
async def stock(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    params = {
        ...
        "apikey": API_KEY,
        "format": "json",
        "outputsize": 365  # 1 year of data to calculate 52w high/low
    }
    ...
    try:
        ...
        # Latest data point is the first in the list
        latest = values[0]
        
        # Extract close price, volume
        close_price = float(latest["close"])
        volume = latest.get("volume", "N/A")
        
        # Calculate 52w high and low from values
